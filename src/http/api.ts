...
export const getSubscribeToEventUrl = () => {
  ...
  return `http://localhost:3000/api/subscriptions`
}
...
export const getAccessInviteLinkUrl = (subscriberId: string,) => {
  ...
  return `http://localhost:3000/api/invites/${subscriberId}`
}
...
export const getGetRankingUrl = () => {
  ...
  return `http://localhost:3000/api/ranking`
}
...
export const getGetSubscriberInviteCountUrl = (subscriberId: string,) => {
  ...
  return `http://localhost:3000/api/subscribers/${subscriberId}/ranking/count`
}
...
export const getGetSubscriberInviteClicksUrl = (subscriberId: string,) => {
  ...
  return `http://localhost:3000/api/subscribers/${subscriberId}/ranking/clicks`
}
...
export const getGetSubscriberRankingPositionUrl = (subscriberId: string,) => {
  ...
  return `http://localhost:3000/api/subscribers/${subscriberId}/ranking/position`
}
